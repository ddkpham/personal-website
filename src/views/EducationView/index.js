      ...
      <div className="education-view__content--info">
        <div className="education-info">
          <div className="education-info__ubc">
            ...
            <p>Course work in Genetics, Virology, Immunology, Industrial Microbiology, Bacterial Pathogenesis, Microbial Ecology, Organic Chemisty, Physical Chemistry, Physics</p>
          </div>
          <div className="education-info__sfu">
            <h1>Simon Fraser University</h1>
            <h2>Bachelors of Computer Science (2017-2020)</h2>
            <p>Course work in Discrete Mathematics, Numerical Analysis, Software Engineering, Software Development Methods, Artificial Intelligence, Bioinformatics, Operating Systems, Databases, Algorithmic Design and Analysis</p>
          </div>
        </div>
      </div>
    </div>
